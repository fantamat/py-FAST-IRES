...
project_id = "ai-tests-459309"
location = "eu" # Format is "us" or "eu"
processor_id = "b569ee6ffe2a01b0" # Create processor before running sample
...
def main():
    doc = process_document_ocr_sample(
        project_id,
        location,
        processor_id,
        processor_version,
        os.path.join("data", "invoices", "ONO.png"),
        mime_type
    )
    a = 5
